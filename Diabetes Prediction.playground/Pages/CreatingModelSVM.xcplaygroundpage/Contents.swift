...
let classifier = try MLSupportVectorClassifier(trainingData: classifierTrainingTable, targetColumn: "Outcome")
...
//
//let classifierMetadata = MLModelMetadata(author: "José Mateus", shortDescription: "Predicts diabetes.", version: "1.0")
//
//try classifier.write(to: desktopPath.appendingPathComponent("DiabetesPredictionSVM.mlmodel"),
