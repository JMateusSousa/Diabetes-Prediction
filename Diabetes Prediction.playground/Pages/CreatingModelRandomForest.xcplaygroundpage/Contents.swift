...
let classifier = try MLRandomForestClassifier(trainingData: classifierTrainingTable, targetColumn: "Outcome")
...
//
//try classifier.write(to: desktopPath.appendingPathComponent("DiabetesPredictionRF.mlmodel"), metadata: classifierMetadata)
